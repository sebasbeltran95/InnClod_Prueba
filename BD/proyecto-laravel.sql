...
-- Volcando datos para la tabla clod.doc_documento: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla clod.pro_proceso: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla clod.roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla clod.users: ~1 rows (aproximadamente)
REPLACE INTO `users` (`id`, `name`, `email`, `password`, `rol`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'sebastian', 'admin@mail.com', '$2y$12$P/auZ21Pc0UCJpEYt5Vm3ekSdwQjpckQd4mxTbE.ee6a3HgTEPbLi', 1, NULL, NULL, '2024-05-22 20:22:22', '2024-05-22 20:22:22');
